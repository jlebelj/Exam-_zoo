...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.MS_e_nom_format_p.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">Le nom est compose de lettre seulement </span></p></body></html>"))
