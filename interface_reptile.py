...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.l_num_r.setGeometry(QtCore.QRect(10, 0, 211, 21))
        font = QtGui.QFont()
        ...
        self.line_num_r.setGeometry(QtCore.QRect(10, 30, 181, 41))
        font = QtGui.QFont()
        ...
        self.CB_alimentation_r.addItem("")
        self.CB_alimentation_r.addItem("")
        self.CB_alimentation_r.addItem("")
        ...
        self.l_nb_dent_r1.setGeometry(QtCore.QRect(290, 60, 221, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line_nb_dent_r.setGeometry(QtCore.QRect(310, 110, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.l_nb_dent_r2.setGeometry(QtCore.QRect(310, 80, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line_temperature_r.setGeometry(QtCore.QRect(310, 230, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.l_temperature_r1.setGeometry(QtCore.QRect(290, 180, 231, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.l_temperature_r2.setGeometry(QtCore.QRect(350, 200, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.MS_e_nb_dent_r.setGeometry(QtCore.QRect(240, 150, 331, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.MS_e_temperature_sup_r.setGeometry(QtCore.QRect(250, 270, 321, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.MS_e_temperature_format_r.setGeometry(QtCore.QRect(260, 290, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.MS_e_num_inex_r = QtWidgets.QLabel(Dialog)
        self.MS_e_num_inex_r.setEnabled(True)
        self.MS_e_num_inex_r.setGeometry(QtCore.QRect(0, 70, 201, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.MS_e_num_inex_r.setFont(font)
        self.MS_e_num_inex_r.setObjectName("MS_e_num_inex_r")
        self.MS_e_serialiser_r = QtWidgets.QLabel(Dialog)
        self.MS_e_serialiser_r.setEnabled(True)
        self.MS_e_serialiser_r.setGeometry(QtCore.QRect(210, 310, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.MS_e_serialiser_r.setFont(font)
        self.MS_e_serialiser_r.setObjectName("MS_e_serialiser_r")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.CB_alimentation_r.setItemText(0, _translate("Dialog", "Herbivore"))
        self.CB_alimentation_r.setItemText(1, _translate("Dialog", "Carnivore"))
        self.CB_alimentation_r.setItemText(2, _translate("Dialog", "Omnivore"))
        self.l_type_animal_r.setText(_translate("Dialog", "Type d\'animal"))
        self.CB_type_animal_r.setItemText(0, _translate("Dialog", "Reptile"))
        self.l_enclos_r.setText(_translate("Dialog", "Enclos du reptile"))
        self.CB_venimeux_r.setItemText(0, _translate("Dialog", "Oui"))
        self.CB_venimeux_r.setItemText(1, _translate("Dialog", "Non"))
        ...
        self.MS_e_num_inex_r.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">Ce numero est inexistant</span></p></body></html>"))
        self.MS_e_serialiser_r.setText(_translate("Dialog", "<html><head/><body><p><br/></p></body></html>"))
